...
public class AcceptTest extends CobolBaseTest {
	...
	public void dateTests(String name, String param, String expected) throws IOException {
		...
		String fileString = IOUtils.toString(fileStream);
	...
	public Object[][] acceptDateTests() {
		return new Object[][] {
			{"DATE",  "DATE",  "180409" },
			{"DATE YYYYMMDD","DATE YYYYMMDD","20180409" },
			{"YYYYMMDD","YYYYMMDD","20180409" },
			{"DAY",   "DAY",   "18099" },
			{"DAY YYYYDDD",     "DAY YYYYDDD",   "2018099" },
			{"YYYYDDD",     "YYYYDDD",   "2018099" },
			{"DAY_OF_WEEK", "DAY-OF-WEEK", "1" },
			{"TODAYS-DATE", "TODAYS-DATE", "040918" },
			{"TODAYS-DATE MMDDYYYY", "TODAYS-DATE MMDDYYYY", "04092018" },
			{"YEAR", "YEAR", "2018" },
			{"TIME", "TIME", "14443355" },
			{"TIMER", "TIMER", "2211398148" },
